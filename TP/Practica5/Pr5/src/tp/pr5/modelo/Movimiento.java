...
{
	protected int _donde;
	protected Ficha _color;
	
	/**
	 * Construye un nuevo Movimiento en base a los parámetros recibidos.
	 * 
	 * @param _donde - posición del tablero (hasta el momento solo representa la columna).
	 * @param _color - Color del jugador que realiza el movimiento.
	 */
	...
	/**
	 * Devuelve el _color del jugador al que pertenece el movimiento. 
	 ...
	 * 
	 * @param tab - Tablero de _donde deshacer el movimiento.
	 */
