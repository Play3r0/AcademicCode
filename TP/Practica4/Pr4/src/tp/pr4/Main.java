...
import tp.pr4.controlador.FactoriaComplica;
import tp.pr4.controlador.FactoriaConecta4;
import tp.pr4.controlador.FactoriaGravity;
import tp.pr4.controlador.FactoriaTipoJuego;
import tp.pr4.modelo.MovimientoInvalido;
import tp.pr4.modelo.Partida;
import tp.pr4.modelo.ReglasJuego;
import tp.pr4.vistas.VistaConsola;
import tp.pr4.vistas.VistaGUI;
...
public class Main {
	...
	public static void main(String[] args) throws MovimientoInvalido {
		...
		{		
			...
			tipoInterfaz = argumentosDeJuego(cmd, "tipoInterfaz", "window");
